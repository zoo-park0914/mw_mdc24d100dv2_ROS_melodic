...
int stella_setting(int select)
{
    ...
    case 0:
        ...
        stella_n1.Max_current[channel_1] = 2.3;
        stella_n1.Max_current[channel_2] = 2.3;
        ...
        stella_n1.velocity_p_gain[channel_1] = 3.3;
        stella_n1.velocity_p_gain[channel_2] = 3.3;

        stella_n1.velocity_i_gain[channel_1] = 0.06;
        stella_n1.velocity_i_gain[channel_2] = 0.06;
